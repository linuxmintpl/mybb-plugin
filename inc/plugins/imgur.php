...
function imgur_activate() {
    ...
    $imgur_template[] = array(
		...
		<div id="abp_imgur_zone" style="width:150px;height:50px;margin:auto; border: 3px dashed #BBBBBB; line-height:50px; text-align: center; background: #000000 url({$mybb->settings[\\\'bburl\\\']}/images/imgur.png) center no-repeat; cursor: pointer;"></div>
<script>
function imgurload() {
